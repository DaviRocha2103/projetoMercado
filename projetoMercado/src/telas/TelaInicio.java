...
public class TelaInicio extends javax.swing.JFrame {
   ...
   public void readJtable() {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/opaiIcone.png"))); // NOI18N

        inputPesquisa.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        inputPesquisa.setForeground(new java.awt.Color(30, 30, 30));
        inputPesquisa.setBorder(null);
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/user-removebg-preview.png"))); // NOI18N
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/sair.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/cart-removebg-preview.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(1263, 728));
    ...
    private void inputPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputPesquisaActionPerformed
        try{
            ...
            stmt = c.prepareStatement("SELECT * FROM produtos WHERE nome like '%"+inputPesquisa.getText()+"%'");
